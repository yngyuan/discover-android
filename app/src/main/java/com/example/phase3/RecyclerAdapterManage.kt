...
class RecyclerAdapterManage(private val reports: ArrayList<Report>) :
    RecyclerView.Adapter<RecyclerAdapterManage.RecyclerViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerViewHolder {
        val card_view =
            LayoutInflater.from(parent.context).inflate(R.layout.card_manage, parent, false)
