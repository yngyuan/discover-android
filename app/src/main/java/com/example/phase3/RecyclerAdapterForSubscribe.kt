...
class RecyclerAdapterForSubscribe(private val reports: ArrayList<Report>) :
    RecyclerView.Adapter<RecyclerAdapterForSubscribe.RecyclerViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerViewHolder {
        val card_view =
            LayoutInflater.from(parent.context).inflate(R.layout.card_subscribe, parent, false)
